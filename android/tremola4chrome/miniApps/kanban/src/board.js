...
window.miniApp = {
    handleRequest: function(command, args) {
        console.log("Kanban handling request:", command);
        switch (command) {
        case "onBackPressed":
            console.log("kanban onBackPressed");
            ...
            break;
        case "plus_button":
            console.log("kanban plus_button");
            menu_new_board();
        case "members_confirmed":
            console.log("kanban members_confirmed");
            menu_new_board_name();
            break;
        case "edit_confirmed":
            console.log("kanban edit_confirmed");
            kanban_edit_confirmed();
            break;
        case "b2f_initialize":
            console.log("kanban b2f_initialize");
            load_board_list();
            break;
        case "b2f_new_event":
            console.log("kanban b2f_new_event");
            load_board_list();
            break;
        }
        return "Response from Kanban";
    }
};
